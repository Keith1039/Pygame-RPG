...
def test_process_events():
    ...
    eventManager.knight.x = 0  # move the knight to a specific spot
    eventManager.process_events("")  # process the events
    ...
    eventManager.knight.x = 175  # move the knight to a specific spot
    eventManager.process_events("something")  # give the right range to trigger the event
    ...
    eventManager.knight.x = 0  # move the knight to a specific spot
    eventManager.process_events("Unobtainable")  # give the right context to trigger the event
